        ...
        try(
                Connection conexion = DriverManager.getConnection(URL_CONEXION, USUARIO_BDD, PASSWORD_BDD)){
                  ...
                  String sql = "CREATE TABLE IF NOT EXISTS personal" +
                          ...
                          "fechaAlta TIMESTAMP, " +
                          "fechaBaja TIMESTAMP, " +
                          "FOREIGN KEY (idServicioOfrecido) REFERENCES servicio (idServicio), "+
                          "esEncargado BOOLEAN)";
